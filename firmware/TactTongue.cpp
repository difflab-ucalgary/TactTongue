...
int TactTongue::CheckWaveform(int electrode[], int PP[], int Pplus[], int IBN[], int IBP[], int OBN[])
{
...
int TactTongue::UpdateStimuli(int electrode[], int PP[], int Pplus[], int IBN[], int IBP[], int OBN[])
{
